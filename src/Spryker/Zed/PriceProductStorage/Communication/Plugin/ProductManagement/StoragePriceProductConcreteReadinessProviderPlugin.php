 ...
 */
class StoragePriceProductConcreteReadinessProviderPlugin extends AbstractPlugin implements ProductConcreteReadinessProviderPluginInterface
{
    /**
     * {@inheritDoc}
     *
     * - Expands product readiness collection with concrete product price existence in a storage.
     *
     * @api
     *
    ...
    public function provide(
        ...
        return $this->getBusinessFactory()
            ->createStoragePriceProductConcreteReadinessProvider()
