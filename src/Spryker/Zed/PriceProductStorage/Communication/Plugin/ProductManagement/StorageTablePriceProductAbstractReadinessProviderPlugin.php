 ...
 */
class StorageTablePriceProductAbstractReadinessProviderPlugin extends AbstractPlugin implements ProductAbstractReadinessProviderPluginInterface
{
    /**
     * Specification:
     * {@inheritDoc}
     * - Expands product readiness collection with price existence in spy_price_product_abstract_storage table.
     *
     * @api
     *
    ...
    public function provide(
        ...
        return $this->getBusinessFactory()
            ->createStorageTablePriceProductAbstractReadinessProvider()
